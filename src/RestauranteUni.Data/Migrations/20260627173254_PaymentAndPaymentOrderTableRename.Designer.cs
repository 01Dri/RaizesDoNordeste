...
namespace RestauranteUni.Data.Migrations
{
    ...
    [Migration("20260627173254_PaymentAndPaymentOrderTableRename")]
    partial class PaymentAndPaymentOrderTableRename
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RestauranteUni.Domain.Core.Payments.Payment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("RestauranteUni.Domain.Core.Payments.PaymentOrder", b =>
                {
                    b.HasOne("RestauranteUni.Domain.Core.Orders.Order", "Order")
                        ...
                        .HasForeignKey("RestauranteUni.Domain.Core.Payments.PaymentOrder", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RestauranteUni.Domain.Core.Payments.Payment", "Payment")
                        .WithOne("PaymentOrder")
                        .HasForeignKey("RestauranteUni.Domain.Core.Payments.PaymentOrder", "PaymentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
